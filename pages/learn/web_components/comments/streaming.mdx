...
Streaming mode will show all the comment dialogs in order of submission on the right hand side of the page. It works well with text-based comments, but you can also use it with freestyle mode.
...
### 2a. Add the comment tool component
