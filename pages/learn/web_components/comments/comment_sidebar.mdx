...
### Add the comment sidebar

Import the component:

```jsx copy
import { SnippylyCommentsSidebar } from '@snippyly/react';
```
...
### 1. Enable embed mode for sidebar
...
### 2. Enable URL based navigation in sidebar
...
### 3. Open, close, or toggle the sidebar programmatically
...
### 4. Navigate to comment location when comment is clicked on the sidebar
