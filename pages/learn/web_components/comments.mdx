...
_Show comments from users on your application._

---

<Comment style="margin-top: 2.5rem" user={"Rachel"} documentId={commentDocumentId} width={200} height={500}/>

## When to use

The `SnippylyComments` component renders any saved comments to the DOM. It must be placed in the root App component of your React app.
...
```html copy
<SnippylyCommentTool class="my-custom-css"></SnippylyCommentTool>
```
...
```html copy
<SnippylyComments pin-highlighter-class="custom-pin-highlighter-class">
</SnippylyComments>
```
