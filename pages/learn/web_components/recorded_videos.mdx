...
```js copy
const recorderElement = Snippyly.getRecorderElement();
...
The above implementation uses `floating` mode. When you start recording in this mode, the recording preview and actions panel will be visible in the bottom left corner, and you will be able to drag and drop recordings to any elements similar to comment pins.
